...
export const Register= () => {
    ...
    return (
        <>
            <div className="bg-orange-500 flex justify-center items-center w-1/2">
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            <button className="bg-blue-900 text-slate-300 border py-2 w-full rounded-xl mt-5 hover:scale-105 duration-300 hover:bg-blue-900 hover:text-white">Register
                            </button>
                        </div>
                    </form>
                    ...
                    <div className="mt-3 text-sm flex justify-between items-center">
                        ...
                        <Link to="/login" className="py-2 px-5 bg-blue-900 text-slate-300 border rounded-xl hover:scale-110 duration-300 hover:bg-blue-900 ">Login</Link>
                    </div>
            ...
            <div className="w-1/2 h-screen bg-[url('/public/images/nino2.jpeg')] 
